...
//
// Register Offsets (Synopsys DWC_mobile_storage v2.40a+)
//
...
// FMP / SMU registers (secure eMMC only, stubbed for SD)
...
#define TUNING_BLOCK_SIZE       64        // CMD19 tuning block (4-bit bus)
...
typedef struct {
  ...
  //
  // SMU configuration (eMMC-only; stubbed for SD)
  //
  BOOLEAN     Secure;
  UINT32      MpsSecurity;
